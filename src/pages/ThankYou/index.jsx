...
function ThankYou() {
  ...
  return (
    <div className="thankyou__wrapper">
      ...
      <Button size="lg" color="primary" className="m-3" onClick={()=>navigate('../')}>Continue to Buy</Button>
    </div>
  );
}
